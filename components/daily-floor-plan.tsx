  ...
  const fetchMealData = useCallback(async () => {
    try {
      ...
      if (selections) {
        selections.forEach((selection) => {
          guestMealSelections[selection.guest_id] = {
            ...
            category: selection.meal_category,
          }
        })
      }
      ...
      guests.forEach((guest) => {
        ...
        let category = "noSelection"
        if (mealSelection) {
          category = mealSelection.category
        }
        ...
        tables[guest.table_nr].mealCounts[category] = (tables[guest.table_nr].mealCounts[category] || 0) + 1
